// Existing Login Popup Code
let login_screen = document.getElementById('popup');
function openlogin() {
    login_screen.classList.add("open-login_screen");
}
function closelogin() {
    login_screen.classList.remove("open-login_screen");
}
